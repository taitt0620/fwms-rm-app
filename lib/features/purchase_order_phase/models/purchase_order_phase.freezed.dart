...
class _$PurchaseOrderPhaseImpl implements _PurchaseOrderPhase {
  ...
  @override
  String toString() {
    return 'PurchaseOrderPhase(id: $id, uri: $uri, poCode: $poCode, expectedDate: $expectedDate, phase: $phase, notes: $notes, totalPrice: $totalPrice, deliver: $deliver, status: $status, listDetails: $listDetails)';
  }
...
abstract class _PurchaseOrderPhase implements PurchaseOrderPhase {
  const factory _PurchaseOrderPhase(
      ...
      @JsonKey(name: "listDetails")
      required final List<ListDetail> listDetails}) = _$PurchaseOrderPhaseImpl;
